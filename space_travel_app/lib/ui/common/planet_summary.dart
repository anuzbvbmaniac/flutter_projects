...
import 'package:space_travel_app/ui/PlanetDetailPage.dart';
import 'package:space_travel_app/ui/common/separator.dart';
      ...
      return new Container(
        child: new Row(
            ...
            children: <Widget>[
              ...
              new Text(planet.gravity, style: Theme.TextStyles.smallTextStyle),
            ]
        ),
      );
    }
    ...
    final planetCardContent = new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          ...
          new Text(planet.name, style: Theme.TextStyles.titleTextStyle),
          new Container(height: 10.0),
          new Text(planet.location, style: Theme.TextStyles.commonTextStyle),
          new Separator(),
          new Row(
